...
2. **Estilo com `styled-components/native` + tokens** — importar de `@zupper/tokens`.
   **Proibido hardcode** de cor/spacing/fonte/radius. Errado: `padding: 16px`.
   Certo: `padding: ${spacing.md}px`.
