...
const SvgTabFotosActive = (props: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 13.667 13.667" {...props}>
    <g stroke="#008C99">
...
export default SvgTabFotosActive;
