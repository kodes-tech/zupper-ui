...
const SvgTabRoteirosInactive = (props: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14.333 13" {...props}>
    <g stroke="#A3A3A3" strokeLinecap="round" strokeLinejoin="round">
...
export default SvgTabRoteirosInactive;
