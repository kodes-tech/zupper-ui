...
describe('Input', () => {
  ...
  it('renders a leading icon when icon is set', () => {
    render(<Input label="Nome Completo" placeholder="Insira seu nome" icon="id-card" />);
    expect(screen.getByPlaceholderText('Insira seu nome')).toBeOnTheScreen();
  });

  it('still shows the error message alongside the icon', () => {
    render(<Input label="Contato" icon="phone" error="Campo obrigatório" />);
