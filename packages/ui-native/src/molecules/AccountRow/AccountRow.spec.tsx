...
describe('AccountRow', () => {
  it('renders the boxed row with subtitle, cta and status', () => {
    render(
      <AccountRow
  ...
  it('renders the inline variant', () => {
    render(<AccountRow icon="account-help" title="Central de ajuda" cta="Ir agora" boxed={false} />);
  ...
  it('fires onPress when tapped', () => {
    ...
    render(<AccountRow icon="account-password" title="Senha" onPress={onPress} />);
    fireEvent.press(screen.getByText('Senha'));
