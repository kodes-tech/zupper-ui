...
describe('BaggageIndicator', () => {
  it('renders the baggage allowance row', () => {
    render(<BaggageIndicator />);
    expect(screen.getByLabelText('Franquia de bagagem')).toBeOnTheScreen();
  });

  it('colors included items with the brand color and excluded items with the border color', () => {
    render(<BaggageIndicator personalItem checkedBaggage={false} carryOn />);
