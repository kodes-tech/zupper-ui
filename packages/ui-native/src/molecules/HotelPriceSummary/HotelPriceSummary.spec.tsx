...
describe('HotelPriceSummary', () => {
  it('renders label, price and the default taxes note', async () => {
    await render(<HotelPriceSummary label="A partir de 10 noites + taxas" price="R$ 3.480" />);
  ...
  it('renders the optional note next to the price', async () => {
    await render(
