...
describe('TripSummaryFooter', () => {
  it('renders the route, date and total price', () => {
    render(<TripSummaryFooter route="GRU - REC" dateLabel="15 de julho" totalPrice="R$ 2.434,67" />);
  ...
  it('fires onPressDetails when "Ver detalhes" is pressed', () => {
